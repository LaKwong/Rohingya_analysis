...
# @Title: Final refugee survey related clean datasets
################################################################################
...
clean_related_survey("hh_members", "survey_refugee_hh_members", "survey_refugee_hh_members.rds")
clean_related_survey("symptoms", "survey_refugee_symptoms", "survey_refugee_symptoms.rds")
clean_related_survey("location", "survey_refugee_location", "survey_refugee_location.rds")
