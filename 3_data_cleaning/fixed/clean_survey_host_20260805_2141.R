...
################################################################################
# Host household-member, symptom, and location subforms
#
# These related survey outputs are now cleaned in this consolidated script.
# They are kept here so the host survey cleaning workflow has one maintained
# entry point for household and related survey files.
################################################################################
clean_host_related_survey <- function(role, dataset_name, output_file) {
...
clean_host_related_survey("hh_members", "survey_host_hh_members", "survey_host_hh_members.rds")
clean_host_related_survey("symptoms", "survey_host_symptoms", "survey_host_symptoms.rds")
clean_host_related_survey("location", "survey_host_location", "survey_host_location.rds")
