...
#   is based on the earlier RF105B_XGBOOST_analysis_all_var.R workflow, but it
#   removes exploratory code, stale input paths, duplicate functions/outcomes,
#   and legacy interaction-model analysis blocks.
#
# Inputs:
...
safe_write_reviewed_csv(
  ...
  "rdid_xgboost_tuning_settings.csv",
  subfolder = "qa"
)
...
calculate_fcs_from_weekly_vars <- function(df) {
  df %>%
    mutate(
      ...
      # This mapping follows 5_analysis/1_Rohingya_hh_survey_analysis/
...
safe_write_reviewed_csv(
  ...
  "rdid_hh_member_timepoint_availability.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_unavailable_baseline_covariates.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_total_income_30_derivation_audit.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_fcs_weekly_variable_availability.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "fcs_recalculated_scores_by_household_timepoint_reviewed.csv"
)
...
safe_write_reviewed_csv(
  ...
  "fcs_recalculated_summary_by_arm_timepoint_reviewed.csv"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_cesd_item_missingness.csv",
  subfolder = "qa"
)
################################################################################
# Outcome list
...
safe_write_reviewed_csv(
  ...
  "rdid_survey_outcome_variable_availability.csv",
  subfolder = "qa"
)
...
rf105_source_outcome_audit <- tribble(
  ...
  "target_child_eye_itch_yn", "target_child_eye_itch_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary yes/no derived from target_child_eye_itch using the original health recode: 0 = no, positive values = yes.",
  "target_child_eye_red_yn", "target_child_eye_red_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary yes/no derived from target_child_eye_red using the original health recode.",
  "target_child_clinic_resp_yn", "target_child_clinic_resp_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary yes/no derived from target_child_clinic_resp; refused/don't know values are set to missing.",
  "target_child_wheezing_yn", "target_child_wheezing_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary yes/no derived from target_child_wheezing; refused/don't know values are set to missing.",
  "target_child_distrubed_speech_yn", "target_child_distrubed_speech_yn", "RF105B_XGBOOST_analysis_all_var.R", "included", "Matches RF105B XGBoost code by setting skipped/missing disturbed-speech responses to 0 before modeling.",
  "respondent_disturbed_speech_yn", "respondent_disturbed_speech_yn", "RF105B_XGBOOST_analysis_all_var.R", "included", "Matches RF105B XGBoost code by setting skipped/missing disturbed-speech responses to 0 before modeling.",
  "respondent_eye_red_yn", "respondent_eye_red_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary any-symptom indicator derived from respondent_eye_red.",
  "respondent_eye_itch_yn", "respondent_eye_itch_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary any-symptom indicator derived from respondent_eye_itch.",
  "respondent_eye_sore_yn", "respondent_eye_sore_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; host respiratory scripts", "included", "Binary any-symptom indicator derived from respondent_eye_sore.",
  "respondent_wheezing_yn", "respondent_wheezing_yn", "RF105B_XGBOOST_analysis_all_var.R", "included", "Binary yes/no derived from respondent_wheezing.",
  "target_child_resp_rate", "target_child_resp_rate_yn", "RF105B_XGBOOST_analysis_all_var.R", "included_as_binary", "Original values are yes/no/don't know/refused; reviewed workflow models the cleaned binary indicator.",
  "target_child_cough", "target_child_cough_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; 11_dif_in_dif_outputs.R", "included_as_binary", "Original values are yes/no/don't know/refused; reviewed workflow models the cleaned binary indicator.",
  "target_child_fever", "target_child_fever_yn", "RF105B_XGBOOST_analysis_all_var.R; 2_respiratory health.R; 11_dif_in_dif_outputs.R", "included_as_binary", "Original values are yes/no/don't know/refused; reviewed workflow models the cleaned binary indicator.",
  "target_child_lethargy", "target_child_lethargy_yn", "2_respiratory health.R; 11_dif_in_dif_outputs.R; host respiratory scripts", "included_as_binary", "Added after audit because this child general-health outcome was in the old household/host scripts.",
  "target_child_weight_loss", "target_child_weight_loss_yn", "2_respiratory health.R; 11_dif_in_dif_outputs.R; host respiratory scripts", "included_as_binary", "Added after audit because this child general-health outcome was in the old household/host scripts.",
  "respondent_cough", "respondent_cough_yn", "1.5_define_vector_columns.R; host respiratory scripts", "included_as_binary", "Added after audit because this respondent respiratory outcome was in the original vector definitions/host scripts.",
  "respondent_disturbed_sleep", "respondent_disturbed_sleep_yn", "11_dif_in_dif_outputs.R; host respiratory scripts", "included_as_binary", "Added after audit; keep sample-size columns visible because this skip-pattern variable has many missing values.",
  "respondent_headache", "respondent_headache_yn", "11_dif_in_dif_outputs.R; host respiratory scripts", "included_as_binary", "Added after audit because this respondent non-respiratory symptom was in the old household/host scripts.",
  "respondent_backache", "respondent_backache_yn", "11_dif_in_dif_outputs.R; host respiratory scripts", "included_as_binary", "Added after audit because this respondent non-respiratory symptom was in the old household/host scripts.",
  "fcs", "fcs", "6.1_food_security.R; 6.1_food_security_host.R; RF105B_XGBOOST_analysis_all_var.R", "included_corrected", "Recalculated from weekly food-group variables, cap at 7 days, apply WFP weights, and classify using <=21, 21.5-35, >35 cutoffs.",
  "fcs_binary", "fcs_binary", "RF105B_XGBOOST_analysis_all_var.R", "included_corrected", "Binary food insecurity indicator equals 1 for poor/borderline FCS (<=35) and 0 for acceptable FCS (>35).",
  "spent_food", "spent_food_usd", "RF105B_XGBOOST_analysis_all_var.R; 0_config.R; 1_config.R", "included_corrected", "Converted from BDT to USD using baseline 84.88, midline 84.74, and endline 93.45 BDT/USD.",
  "buy_wood_cost", "buy_wood_cost_usd", "RF105B_XGBOOST_analysis_all_var.R; 0_config.R; 1_config.R", "included_corrected", "Converted from BDT to USD using baseline 84.88, midline 84.74, and endline 93.45 BDT/USD.",
  "fuel_30_gather_scraps", "fuel_30_gather_scraps_yn", "3.2.2_stove_uses.R; 3.2_fuel_sources_CHRIS CODE.R", "included_as_alias", "Derived from the reviewed fuel_30_gather_scraps alias created from fuel_30_scraps when needed.",
  "fuel_30_buy_wood", "fuel_30_buy_wood_yn", "3.2.2_stove_uses.R; 3.2_fuel_sources_CHRIS CODE.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_receive_wood", "fuel_30_receive_wood_yn", "3.2.2_stove_uses.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_receive_lpg", "fuel_30_receive_lpg_yn", "3.2.2_stove_uses.R; 3.2_fuel_sources_CHRIS CODE.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_buy_lpg", "fuel_30_buy_lpg_yn", "3.2.2_stove_uses.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_receive_crh", "fuel_30_receive_crh_yn", "3.2.2_stove_uses.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_buy_crh", "fuel_30_buy_crh_yn", "3.2.2_stove_uses.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "fuel_30_other", "fuel_30_other_yn", "3.2.2_stove_uses.R", "included", "Binary yes/no derived with refused/don't know values set to missing.",
  "burn_plastic_frequency", "plastic_burn_gt1_yn", "3.3_plastic_burning_new.R", "included_corrected", "Matches the old plastic_burn_yn definition: burn_plastic_frequency > 1.",
  "boil_yesterday_times", "boil_yesterday_times_clean", "3.2.2_stove_uses.R; 7.2_mental_health.R", "included", "Non-negative number of times the household boiled water yesterday.",
  "income_wage_labor", "income_wage_labor_usd", "0_data_analysis_Rohingya.Rmd", "included_corrected", "Converted from BDT to USD using timepoint-specific exchange rates.",
  "income_cash_ngo", "income_cash_ngo_usd", "0_data_analysis_Rohingya.Rmd", "included_corrected", "Converted from BDT to USD using timepoint-specific exchange rates.",
  "spent_total_month_with_6mo_monthly", "spent_total_month_usd", "0_data_analysis_Rohingya.Rmd", "included_with_clean_final_rename", "The exact old variable is absent from clean_final; reviewed code uses spent_total_month, the available cleaned total monthly expenditure field.",
  "spent_tobacco_pan", "spent_tobacco_pan_usd", "0_data_analysis_Rohingya.Rmd", "included_corrected", "Converted from BDT to USD using timepoint-specific exchange rates.",
  "spent_food_pct", "spent_food_pct", "5.1_income_expenditures.R", "included_corrected", "Reviewed code calculates spent_food / spent_total_month when both values are nonmissing and total spending is >0; the old if_else expression returned a logical value for most positive food-spending records.",
  "total_income_30", "total_income_30_usd", "0_data_analysis_Rohingya.Rmd; 5.1_income_expenditures.R", "included_corrected", "Baseline total_income_30 is calculated as the sum of income_cash_ngo, income_own_business, income_wage_labor, income_skill_labor, income_selling_wood, income_abroad, income_humanitarian_asst, income_handicrafts_tailoring, and income_farming when the aggregate is missing; follow-up reported aggregates are preserved when nonmissing. Converted from BDT to USD using timepoint-specific exchange rates.",
  "CES_D_o16_score", "CES_D_o16_score", "7.2_mental_health.R; RF105B_XGBOOST_analysis_all_var.R", "included_corrected", "CES-D score is the sum of all 20 cleaned CES-D items; reviewed code now sets the score to missing if any item is missing, matching rowwise sum() behavior.",
  "suicidal_thoughts_30_yn", "suicidal_thoughts_30_yn", "2_tidy_Rohingya_refugee_and_host_data.R; RF105B_XGBOOST_analysis_all_var.R", "included", "Binary indicator equals 0 for never and 1 for any nonzero frequency.",
  "target_child_asthma", "target_child_asthma", "RF105B_XGBOOST_analysis_all_var.R", "included", "Binary asthma proxy equals child wheeze.",
  "target_child_severe_asthma", "target_child_severe_asthma", "RF105B_XGBOOST_analysis_all_var.R", "included_corrected", "Corrected to wheeze AND disturbed speech only; the reviewed script had incorrectly included disturbed sleep.",
  "respondent_resp_rate", NA_character_, "1.5_define_vector_columns.R; host respiratory scripts", "not_available_in_clean_final", "Column was referenced in old vector definitions/host code but is not present in survey_refugee_household.rds.",
  "respondent_weight_loss", NA_character_, "1.5_define_vector_columns.R; host respiratory scripts", "not_available_in_clean_final", "Column was referenced in old vector definitions/host code but is not present in survey_refugee_household.rds.",
  "respondent_eye_red", "respondent_eye_red_yn", "11_dif_in_dif_outputs.R", "represented_as_binary", "The old exploratory DiD file also included raw ordinal/frequency symptom variables; reviewed RF105B rDiD models the binary any-symptom indicators used by the RF105B XGBoost workflow.",
  "respondent_eye_itch", "respondent_eye_itch_yn", "11_dif_in_dif_outputs.R", "represented_as_binary", "The old exploratory DiD file also included raw ordinal/frequency symptom variables; reviewed RF105B rDiD models the binary any-symptom indicators used by the RF105B XGBoost workflow.",
  "respondent_eye_sore", "respondent_eye_sore_yn", "11_dif_in_dif_outputs.R", "represented_as_binary", "The old exploratory DiD file also included raw ordinal/frequency symptom variables; reviewed RF105B rDiD models the binary any-symptom indicators used by the RF105B XGBoost workflow.",
  "respondent_wheezing", "respondent_wheezing_yn", "11_dif_in_dif_outputs.R", "represented_as_binary", "The old exploratory DiD file also included raw yes/no variables; reviewed RF105B rDiD models the cleaned binary indicator."
) %>%
  mutate(
...
safe_write_reviewed_csv(
  ...
  "rdid_outcome_code_audit_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_harassment_variable_availability_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_harassment_candidate_prevalence_by_arm_timepoint_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_harassment_estimability_reviewed.csv"
)
safe_write_reviewed_csv(
  rdid_harassment_estimability,
  "rdid_harassment_estimability_reviewed.csv",
...
requested_rdid_outcome_coverage <- tribble(
  ...
  9, "Dietary diversity", "not_rdid_estimable", NA_character_, "food_consump_adult_day/1 through food_consump_adult_day/15", "Dietary diversity inputs are available at midline/endline but are missing at baseline in clean_final, so baseline-to-follow-up rDiD cannot be estimated.",
...
safe_write_reviewed_csv(
  ...
  "rdid_requested_outcome_coverage_reviewed.csv",
  subfolder = "qa"
)

outcome_audit_summary_file <- file.path(
  dir_tables_qa,
  "rdid_outcome_code_audit_summary.md"
)
...
writeLines(
  c(
    ...
    "",
    "Source scripts checked:",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/0_data_analysis_Rohingya.Rmd",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/2_respiratory health.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/3.2.2_stove_uses.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/3.3_plastic_burning_new.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/5.1_income_expenditures.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/5_hh_expenditures_debt.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/6.1_food_security.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/7.2_mental_health.R",
    "- 5_analysis/1_Rohingya_hh_survey_analysis/11_dif_in_dif_outputs.R",
    "- 5_analysis/2_Rohingya_individual_survey_analysis/1_data_analysis_individual_Rohingya.Rmd",
    "- 5_analysis/3_host_hh_survey_analysis/1_data_analysis_host.Rmd",
    "- 5_analysis/4_host_individual_survey_analysis/2_respiratory health_host.R",
    "- 5_analysis/4_host_individual_survey_analysis/6.1_food_security_host.R",
    "- 5_analysis_RF105/original/RF105B_XGBOOST_analysis_all_var.R",
    "",
    "Corrections made in the reviewed workflow:",
    "- FCS is recalculated from weekly food-group variables using the same caps, weights, and category cutoffs as the older food-security scripts.",
    "- CES-D now requires all 20 cleaned CES-D items to be nonmissing, matching the old rowwise sum() behavior.",
    "- The severe-asthma proxy now matches RF105B_XGBOOST_analysis_all_var.R: child wheeze AND disturbed speech. The earlier reviewed script had also counted disturbed sleep.",
    "- Food and wood expenditures now use the project exchange rates from 0_config.R/1_config.R and the RF105 XGBoost script: 84.88, 84.74, and 93.45 BDT/USD for baseline, midline, and endline.",
    "- Additional prior health outcomes from the older household/host scripts were added as binary rDiD outcomes where the clean_final columns are available: child lethargy, child weight loss, respondent cough, respondent disturbed sleep, respondent headache, and respondent backache.",
    "",
    "Documented discrepancies or limitations:",
    "- respondent_resp_rate and respondent_weight_loss were referenced in old vector definitions/host code but are not present in survey_refugee_household.rds, so they cannot be modeled from clean_final.",
    "- Harassment rDiD estimates are intentionally not modeled. Baseline harassment variables lack harmonized recall wording in the draft code, midline variables use _ever since-arrival wording, and endline household harassment variables are not nonmissing in clean_final. See rdid_harassment_estimability_reviewed.csv.",
    "- The older exploratory DiD file included some raw ordinal symptom variables. The reviewed RF105B rDiD workflow models the cleaned binary indicators used in the RF105B XGBoost workflow, and the audit CSV records those mappings.",
    "",
    "See rdid_outcome_code_audit_reviewed.csv for the row-level outcome mapping.",
    "See rdid_requested_outcome_coverage_reviewed.csv for the explicit modeled/not-estimable status of each requested intervention-impact outcome."
  ),
...
find_ambient_adjusted_pm_file <- function() {
  ...
  if (length(candidate_files) == 0) {
    stop(
      ...
      "5_analysis_RF105/6_PM_analysis/3_pm25_ambient_adjusted_analysis.R before ",
      "4_rdid_xgboost_reviewed.R so the reviewed PM rDiD uses adjusted data.",
      call. = FALSE
    )
  }
...
safe_write_reviewed_csv(
  ...
  "rdid_pm25_adjusted_data_source_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  pm_household_counts,
  "rdid_pm25_adjusted_household_counts_by_arm_timepoint_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_pm25_adjusted_missing_timepoint_counts_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_baseline_covariate_missingness.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  pm_panel_counts,
  "rdid_pm25_paired_household_counts_reviewed.csv",
  subfolder = "qa"
)
safe_write_reviewed_csv(
  pm_panel_id_audit,
  "rdid_pm25_paired_household_ids_reviewed.csv",
  subfolder = "qa"
)
...
safe_write_reviewed_csv(
  ...
  "rdid_xgboost_all_results_reviewed.csv"
)
safe_write_reviewed_csv(
  rdid_glm_results,
  "rdid_glm_sensitivity_all_results_reviewed.csv"
)
...
safe_write_reviewed_csv(
  rdid_sample_counts,
  "rdid_sample_counts_by_outcome_reviewed.csv",
  subfolder = "qa"
)
...
pm_missing_timepoint_note <- if (nrow(pm_missing_timepoint_counts) == 0) {
  ...
  paste0(
    "Rows with missing or invalid timepoint remain; see `rdid_pm25_adjusted_missing_timepoint_counts_reviewed.csv` for details. Total rows: ",
...
pm_audit_summary_file <- file.path(
  dir_tables_reviewed,
  "qa",
  "rdid_pm25_timepoint_panel_audit_summary.md"
)
writeLines(
  c(
    ...
    paste(
      ...
      "5_analysis_RF105/6_PM_analysis/3_pm25_ambient_adjusted_analysis.R.",
    ...
    "",
    "Detailed rows are in `rdid_pm25_adjusted_data_source_reviewed.csv`, `rdid_pm25_adjusted_household_counts_by_arm_timepoint_reviewed.csv`, `rdid_pm25_paired_household_counts_reviewed.csv`, `rdid_pm25_paired_household_ids_reviewed.csv`, and `rdid_xgboost_all_results_reviewed.csv`."
  ),
...
plot_specs <- tribble(
  ...
  "primary_baseline_midline", "binary", "rdid_xgboost_primary_baseline_midline_binary_estimates_reviewed.png", 11, 16,
  "primary_baseline_midline", "continuous", "rdid_xgboost_primary_baseline_midline_continuous_estimates_reviewed.png", 9, 4,
  "secondary_baseline_endline", "binary", "rdid_xgboost_secondary_baseline_endline_binary_estimates_reviewed.png", 11, 16,
  "secondary_baseline_endline", "continuous", "rdid_xgboost_secondary_baseline_endline_continuous_estimates_reviewed.png", 9, 4
)
...
standardize_previous_results <- function() {
  previous_health_file <- find_previous_reviewed_file(
    "health_unadjusted_did_sensitivity_reviewed.csv"
  )
  previous_pm_file <- find_previous_reviewed_file(
  ...
  if (!is.na(previous_health_file)) {
    out$health <- readr::read_csv(previous_health_file, show_col_types = FALSE) %>%
      mutate(
        ...
        previous_significant = estimate_significance(
  ...
  bind_rows(out) %>%
    ...
    arrange(
      desc(coalesce(previous_population, "") == "all_deduplicated_records"),
      previous_population,
      .by_group = TRUE
    ) %>%
    slice(1) %>%
...
safe_write_reviewed_csv(
  ...
  "rdid_original_vs_new_significance_change_audit.csv"
)
...
summary_lines <- c(
  ...
  "## What Changed",
  "",
  "The reviewed workflow now uses reverse difference-in-differences (rDiD) with cross-fit XGBoost nuisance models for outcomes that were previously assessed with DiD-style models in the reviewed scripts.",
  "",
  ...
  if (nrow(previous_results) == 0) {
    ...
    paste0(
      "Automated comparisons used previous reviewed output files for ",
...
summary_file <- file.path(
  dir_tables_reviewed,
  "rdid_original_vs_new_results_summary.md"
)
