...
#     1) 5_analysis/5_geocene_analysis/1_stove_use_analysis_cl.R
#     2) 5_analysis/5_geocene_analysis/2_RF105_Fig2_code.R
#     3) 5_analysis/5_geocene_analysis/3_RF105_SupplementTable_stove_use_day.R
#
...
write_reviewed_csv(
  source_scripts,
  "geocene_stove_use_source_script_audit_reviewed.csv",
  subfolder = "qa"
)
...
write_reviewed_csv(
  ...
  "geocene_stove_use_source_code_pattern_audit_reviewed.csv",
  subfolder = "qa"
)
write_reviewed_csv(
  known_issue_notes,
  "geocene_stove_use_known_issue_notes_reviewed.csv",
  subfolder = "qa"
)
...
write_reviewed_csv(
  ...
  "geocene_stove_use_raw_path_audit_reviewed.csv",
  subfolder = "qa"
)
...
write_reviewed_csv(
  stove_var_audit,
  "geocene_stove_use_variable_availability_reviewed.csv",
  subfolder = "qa"
)
...
# Preserve the original missingness used to infer whether a fuel had a recorded
...
write_reviewed_csv(
  ...
  "geocene_stove_use_duplicate_fcn_date_reviewed.csv",
  subfolder = "qa"
)
...
write_reviewed_csv(
  qa_checks,
  "geocene_stove_use_data_quality_checks_reviewed.csv",
  subfolder = "qa"
)
...
write_reviewed_csv(
  sample_counts,
  "geocene_stove_use_sample_counts_reviewed.csv"
)
...
write_reviewed_csv(
  daily_summary,
  "geocene_stove_use_daily_summary_reviewed.csv"
)
...
write_reviewed_csv(
  ...
  "geocene_stove_use_rf105_fig2_plot_data_reviewed.csv"
)
...
save_reviewed_plot(
  fig2_combined,
  "geocene_stove_use_rf105_fig2_reviewed.png",
  width = 7,
  height = 8
)
...
save_reviewed_plot(
  fig2_minutes,
  "geocene_stove_use_minutes_by_day_after_receipt_reviewed.png",
  width = 7,
  height = 4.5
)
save_reviewed_plot(
  fig2_percent,
  "geocene_stove_use_percent_by_day_after_receipt_reviewed.png",
  width = 7,
  height = 4.5
)
save_reviewed_plot(
  fig2_monitored,
  "geocene_stove_use_stoves_monitored_by_day_after_receipt_reviewed.png",
  width = 7,
  height = 4.5
)
...
write_reviewed_csv(
  ...
  "geocene_stove_use_exclusive_lpg_by_household_month_reviewed.csv"
)
write_reviewed_csv(
  exclusive_use_by_month_summary,
  "geocene_stove_use_exclusive_lpg_by_month_summary_reviewed.csv"
)
...
save_reviewed_plot(
  ...
  "geocene_stove_use_exclusive_lpg_since_month_received_reviewed.png",
  width = 7,
  height = 4.5
)
...
write_reviewed_csv(
  ...
  "geocene_stove_use_supplement_day_summary_reviewed.csv"
)
write_reviewed_csv(
  supplement_pct_lpg_distribution,
  "geocene_stove_use_supplement_pct_lpg_distribution_reviewed.csv"
)
...
# original comments mix power and energy units, so this output should be treated
...
write_reviewed_csv(
  energy_summary,
  "geocene_stove_use_energy_summary_reviewed.csv"
)
...
write_reviewed_csv(
  energy_plot_data,
  "geocene_stove_use_energy_plot_data_reviewed.csv"
)
...
save_reviewed_plot(
  fig_energy_day,
  "geocene_stove_use_energy_by_day_after_receipt_reviewed.png",
  width = 7,
  height = 4.5
)
