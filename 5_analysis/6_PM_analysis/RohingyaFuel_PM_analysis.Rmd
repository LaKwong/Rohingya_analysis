...
```{r file_paths}
#Input Files
list_of_file_path_pats_pre_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_BASELINE/Pre_intervention/PATS+"

list_of_file_path_pats_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_BASELINE/Intervention/PATS+"

list_of_file_path_pats_post_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_ENDLINE/Post_intervention/PATS+"

list_of_file_path_pats_intervention_fu <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_ENDLINE/Intervention follow-up/PATS+"


list_of_file_path_hapex_pre_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_BASELINE/Pre_intervention/HAPEX"

list_of_file_path_hapex_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_BASLEINE/Intervention/HAPEX"

list_of_file_path_hapex_post_intervention <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_ENDLINE/Post_intervention/HAPEX"

list_of_file_path_hapex_intervention_fu <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/ALL DATA_ENDLINE/Intervention follow-up/HAPEX"
...
all_pm_data_path_rds <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/PATS+_Data_20210114.rds"

all_hapex_data_path_rds <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/Hapex_Data_20210114.rds"

all_hapex_data_path_csv <- "C:/Users/admin/Google Drive (lakwong@stanford.edu)/Rohingya/Rohingya research - Fuel/Sensors/Hapex_Data_20210114.csv"

file_out_pm_data_base <- here::here("data/pm_data_base.rds")

pm_data_min_rds <- here::here("data/pm_data_min.rds")

pm_data_nearest_min_rds <- here::here("data/pm_data_nearest_min.rds")

pm_data_hour_rds <- here::here("data/pm_data_hour.rds")

pm_data_nearest_hour_rds <- here::here("data/pm_data_nearest_hour.rds")

pm_data_min_csv <- here::here("data/pm_data_min.csv")

pm_data_nearest_min_csv <- here::here("data/pm_data_nearest_min.csv")

pm_data_hour_csv <- here::here("data/pm_data_hour.csv")

pm_data_nearest_hour_csv <- here::here("data/pm_data_nearest_hour.csv")


# Manually move the compiled file into the raw folder of the project
file_pm_data_base <- here::here("data-raw", "PATS+_Data_20210114.rds")
file_HAPEX_data_base <- here::here("dat-raw", "HAPEX_Data_20210114.rds")
```
