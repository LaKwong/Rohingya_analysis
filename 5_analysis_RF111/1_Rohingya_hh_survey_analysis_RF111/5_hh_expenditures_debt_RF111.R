...
monthly_expenditures_base <- 
	...
	select(-c(fuel_30_buy_wood, fuel_30_buy_lpg, fuel_30_buy_crh)) %>% #spent_total_month
	mutate(
...
monthly_expenditures_base %>%
	...
	summarise(income_mean = mean(expenditure, na.rm = TRUE), sd = sd(expenditure, na.rm = TRUE))
